...
import { EmptyState, Field, Panel, cn } from '../ui';
...
const permissionScopes = [
  ...
  ['power', 'Start, stop, restart'], ['settings', 'Settings and variables'], ['databases', 'Databases'], ['backups', 'Backups'], ['schedules', 'Schedules']
] as const;
