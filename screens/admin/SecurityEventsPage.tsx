...
import { LiveStatus } from '../../components/feedback/LoadingStates';
import { BanManagementPanel } from '../../components/admin/BanManagementPanel';
...
function SecurityEventsPage({ nodes, connection, apiBase, showToast }: { nodes: CrowdSecNodeTelemetry[]; connection: LiveConnectionState; apiBase: string; showToast: (message: string, tone?: any) => void }) {
